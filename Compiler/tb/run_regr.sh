...
echo "RUN STATISTICS : TESTLIST : $TL Total Tests = $num_tests PASS = $pass_count RELAX PASS = $relax_pass_count FAIL = $fail_count SKIPPED = $skip_tests" >> $2/regression_summary2.log
...
mv $2/regression_summary.log $2/${TL}_regression_summary.log
